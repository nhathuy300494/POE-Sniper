...
type Tab = "search" | "watches" | "opportunities" | "build" | "ledger" | "alerts" | "settings";
      ...
      <div className="app-shell">
        ...
        <header className="app-header">
          ...
          <nav className="app-nav">
            {(["search","watches","opportunities","build","ledger","alerts","settings"] as Tab[]).map(tab => (
              <button
                key={tab}
        ...
        <main className="app-body">
          ...
          <div className={`tab-panel ${activeTab === "opportunities" ? "active" : ""}`}>
            <OpportunitiesPanel />
          </div>
          <div className={`tab-panel ${activeTab === "build" ? "active" : ""}`}>
            <BuildAgentPanel />
          </div>
...
const NAV_ICONS: Record<Tab, React.ReactNode> = {
  ...
  opportunities: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M3 17l6-6 4 4 8-8"/><path d="M14 7h7v7"/></svg>,
  build: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M12 2l3 7h7l-5.5 4.2L18.5 21 12 16.6 5.5 21l2-7.8L2 9h7z"/></svg>,
  ledger: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M4 3h16v18H4z"/><path d="M8 7h8M8 11h8M8 15h5"/></svg>,
